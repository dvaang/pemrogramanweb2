...
<body>
    ...
    <div class="row">
      <div class="col-3">
        ...
        <div class="list-group">
          ...
          list-group-item-action <?= current_url() == base_url('index.php/admin/dashboard') ? 'active' : '' ?>" aria-current="true">
            Dashboard </a>
          <a href="<?= base_url('admin/daftar-buku') ?>" class="list-group-item 
          list-group-item-action <?= current_url()  ==  base_url('index.php/admin/daftar-buku') ? 'active' : '' ?>">Daftar buku</a>
        </div>
      </div>
      <div class="col-9">
  ...
  <footer class="bg-danger-subtle py-5 mt-auto">
    <div class="container">
