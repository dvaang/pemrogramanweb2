  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="?index.php./nuku/simpan" id="formTambah" method="POST">
          <div class="mb-3">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" from="formTambah" class="btn btn-primary"><i class="bi bi-flopppy">
        </i>Simpan</button>
      </div>
    </div>
  </div>
...
aria-labelledby="hapusModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/index.php/buku/hapus" method="POST">
